...
const FeaturesCard = ({ icon, title, text }) => {
  return (
    <div className="flex justify-center items-center flex-col text-center w-[320px] h-[320px] bg-none rounded-xl border-2 border-solid border-gray-600 hover:bg-blue-950 ease-in-out duration-200">
